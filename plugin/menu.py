...
class MainMenu:
    ...
    def update_limited_view_x(self, slider):
        ...
        self._plugin_instance.update_content(self.label_limit_x)
    ...
    def update_limited_view_y(self, slider):
        ...
        self._plugin_instance.update_content(self.label_limit_y)
        self.limited_view_pos = [self.limit_x, self.limit_y, self.limit_z]
        self.update_mesh_limited_view()
        x = str(round(self.limit_x, 2))
        y = str(round(self.limit_y, 2))
    ...
    def update_limited_view_z(self, slider):
        ...
        self._plugin_instance.update_content(self.label_limit_z)
        self.limited_view_pos = [self.limit_x, self.limit_y, self.limit_z]
        self.update_mesh_limited_view()
        x = str(round(self.limit_x, 2))
        y = str(round(self.limit_y, 2))
    ...
    def update_opacity(self, alpha):
        ...
        self.lbl_opacity_value.text_value = str(round(self.opacity, 2))
        self._plugin_instance.update_content(self.lbl_opacity_value)
